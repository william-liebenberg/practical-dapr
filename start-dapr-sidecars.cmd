...
start "gateway-api" dapr run --app-port 7192 --dapr-http-port 3500 --app-ssl --components-path ./components/ --app-id gateway-api -- dotnet run -lp https --project ./DaprShop.Gateway.API/DaprShop.Gateway.API.csproj
