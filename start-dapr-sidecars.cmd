...
start "notifications-api"	dapr run --app-id notifications-api	--app-port 7196 --app-ssl --components-path ./components/ -- dotnet run -lp https --project ./DaprShop.Products.API/DaprShop.Products.API.csproj
